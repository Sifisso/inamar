...
import mz.ciuem.inamar.service.impl.PeticaoServiceImpl;
...
public class GerirPeticaoCtrl extends GenericForwardComposer{
	...
	private PeticaoEmbarcacao _peticaoEmbarcacao = null;
	...
	public void onClickTratar(ForwardEvent e){
		...
		Map<String, Object> mapContaReceber = new HashMap<String, Object>();
		mapContaReceber.put("peticao", _pet);
		Executions.createComponents("/views/Tesouraria/tratar_peticaoGeral.zul", win_regPedidoExpediente, mapContaReceber);
	}
	...
	private void listarPeticao() {
		if(funcionario==null){
			...
			listPeticao = _peticaoService.buscarPeticoesPorDelegacaoTesouraria(funcionario.getSector().getDelegacaoDepartamento().getDelegacao());
		}
	...
	public void onClickVerFacturaa(ForwardEvent e) throws JRException{
    	Peticao p = (Peticao) e.getData();
    	_peticaoService.onClickVerFacturaa(p, win_regPedidoExpediente);
}
