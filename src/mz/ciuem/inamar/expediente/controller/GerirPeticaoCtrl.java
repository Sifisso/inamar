...
import mz.ciuem.inamar.controller.GestaoGeralCtrl;
...
import mz.ciuem.inamar.util.GravarRedirecionar;
...
public class GerirPeticaoCtrl extends GenericForwardComposer{
	...
	public void doBeforeComposeChildren(Component comp) throws Exception {
		...
		Executions.getCurrent().getSession().removeAttribute("p");
	...
	public void onClickEncaminhar(final ForwardEvent e) {
   	...
   	public void onClick$btn_imprimir(Event e) throws JRException{
        ...
        mapaParam.put("valorTaxa", listPeticao);
        @SuppressWarnings("unchecked")
	...
	public void onSelect$cbx_pedido(){
		...
		List<PedidoRequisito> _listPR = _pedidoRequisitoService.findByPedidoActivoVisivelParaUtente(pedido);
	...
	public void onClickRecusa(ForwardEvent e){
		Peticao pet = (Peticao) e.getData();
		_peticaoService.onClickRecusa(pet, inc_main, div_content_out);
